...
/**
 * Idempotente: añade payment_proof_* donde falten (por si Version20260512140000
 * no llegó a aplicarse en algún esquema con work_invoice).
 */
final class Version20260519120000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Work: catch-up payment_proof_* en work_invoice (todos los esquemas)';
    }
